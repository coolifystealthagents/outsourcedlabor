...
const allBlogPosts = [
  ...
  { slug: 'philippines-outsourced-admin-workload', title: 'How to scope outsourced admin workload', excerpt: 'Turn a mixed admin list into a manageable lane with volume, deadlines, access limits, and a clear owner.', minutes: 9 },
  { slug: 'filipino-customer-support-service-boundaries', title: 'Set service boundaries for Filipino customer support', excerpt: 'Give support staff clear answers they can own and a safe route for exceptions that need a manager.', minutes: 10 },
  { slug: 'outsourced-labor-operations-intake', title: 'Build an intake path for outsourced operations work', excerpt: 'Capture the request, source, deadline, decision owner, and definition of done before work enters a queue.', minutes: 9 },
  { slug: 'philippines-admin-calendar-permission', title: 'Share calendar access safely with Philippines admin staff', excerpt: 'Choose the right calendar permissions and rules for scheduling without exposing sensitive events.', minutes: 8 },
  { slug: 'filipino-ecommerce-order-exceptions', title: 'Handle ecommerce order exceptions with Filipino support', excerpt: 'Give a support lane a practical way to check facts, update customers, and escalate unusual orders.', minutes: 10 },
  { slug: 'outsourced-labor-role-scorecard', title: 'Create a fair scorecard for an outsourced role', excerpt: 'Measure accuracy, completeness, judgment, and timeliness without reducing the role to a volume target.', minutes: 10 },
  { slug: 'philippines-remote-team-communication-rules', title: 'Set communication rules for a Philippines remote team', excerpt: 'Agree on channels, response expectations, urgent cases, and records before work crosses time zones.', minutes: 9 },
  { slug: 'filipino-bookkeeping-document-prep', title: 'Prepare bookkeeping documents with Filipino staff', excerpt: 'Separate document preparation from financial decisions with source checks, naming rules, and review ownership.', minutes: 11 },
  { slug: 'outsourced-labor-backup-owner-plan', title: 'Choose a backup owner for outsourced work', excerpt: 'Protect a recurring work lane by naming backup coverage, current status notes, and the decisions that cannot wait.', minutes: 9 },
  { slug: 'philippines-crm-record-standards', title: 'Set CRM record standards for Philippines-based staff', excerpt: 'Define required fields, source notes, duplicate rules, and review checks for clean customer records.', minutes: 9 },
  { slug: 'filipino-admin-document-review', title: 'Use Filipino admin staff for document review', excerpt: 'Make document review dependable with a checklist for completeness, changes, sensitive details, and escalation.', minutes: 10 },
  { slug: 'outsourced-labor-customer-update-guide', title: 'Write customer update rules for outsourced support', excerpt: 'Give staff a clear way to share approved status information while keeping promises and exceptions with the owner.', minutes: 9 },
  { slug: 'philippines-vendor-follow-up-ownership', title: 'Assign vendor follow-up to Philippines-based staff', excerpt: 'Keep vendor follow-up moving with a source record, next date, escalation rule, and owner for commitments.', minutes: 9 },
  { slug: 'filipino-virtual-assistant-calendar-planning', title: 'Plan calendar work for a Filipino virtual assistant', excerpt: 'Scope scheduling support around meeting rules, time zones, private events, and approval points.', minutes: 8 },
  { slug: 'outsourced-labor-work-queue-aging', title: 'Use queue age to improve outsourced work', excerpt: 'Review waiting items by age and reason so managers can fix bottlenecks instead of asking for faster work.', minutes: 9 },
  { slug: 'philippines-support-knowledge-handoff', title: 'Hand customer knowledge to Philippines support staff', excerpt: 'Transfer the facts, examples, limits, and escalation cues a support worker needs to answer consistently.', minutes: 10 },
  { slug: 'filipino-operations-daily-status', title: 'Write a useful daily status for Filipino operations staff', excerpt: 'Summarize completed work, blocked items, decisions needed, and risks in a short manager-ready note.', minutes: 8 },
  { slug: 'outsourced-labor-access-review', title: 'Review tool access for outsourced labor roles', excerpt: 'Match each permission to the work it supports, the approving owner, and the point when access should change.', minutes: 10 },
  { slug: 'philippines-admin-invoice-workflow', title: 'Scope invoice preparation for Philippines admin support', excerpt: 'Let staff organize invoice information while keeping approvals, payment changes, and exceptions with a manager.', minutes: 10 },
  { slug: 'filipino-customer-feedback-review', title: 'Review customer feedback with Filipino staff', excerpt: 'Turn feedback into clear categories, evidence, follow-up actions, and owner decisions.', minutes: 9 },
  { slug: 'outsourced-labor-first-week-review', title: 'Run a first-week review for outsourced labor', excerpt: 'Use real examples to decide whether a new work lane is ready to continue, change, or stop.', minutes: 9 },
  { slug: 'philippines-remote-staff-continuity', title: 'Plan continuity for Philippines-based remote staff', excerpt: 'Identify the work that can pause, the records that must stay current, and the owner for urgent decisions.', minutes: 10 },
] as const;
...
const aug13BlogSlugs = new Set([
  'philippines-outsourced-admin-workload','filipino-customer-support-service-boundaries','outsourced-labor-operations-intake','philippines-admin-calendar-permission','filipino-ecommerce-order-exceptions','outsourced-labor-role-scorecard','philippines-remote-team-communication-rules','filipino-bookkeeping-document-prep','outsourced-labor-backup-owner-plan','philippines-crm-record-standards','filipino-admin-document-review','outsourced-labor-customer-update-guide','philippines-vendor-follow-up-ownership','filipino-virtual-assistant-calendar-planning','outsourced-labor-work-queue-aging','philippines-support-knowledge-handoff','filipino-operations-daily-status','outsourced-labor-access-review','philippines-admin-invoice-workflow','filipino-customer-feedback-review','outsourced-labor-first-week-review','philippines-remote-staff-continuity',
]);
...
const aug13Topics = [
  ['philippines-outsourced-admin-workload','admin workload','the admin workload','SBA hiring and managing employees'], ['filipino-customer-support-service-boundaries','customer support boundaries','customer support boundaries','SBA hiring and managing employees'], ['outsourced-labor-operations-intake','operations intake','an operations intake path','SBA hiring and managing employees'], ['philippines-admin-calendar-permission','calendar permissions','calendar permissions','CISA Require Multifactor Authentication'], ['filipino-ecommerce-order-exceptions','order exceptions','ecommerce order exceptions','SBA hiring and managing employees'], ['outsourced-labor-role-scorecard','role scorecards','an outsourced role scorecard','SBA hiring and managing employees'], ['philippines-remote-team-communication-rules','remote communication','remote team communication rules','SBA hiring and managing employees'], ['filipino-bookkeeping-document-prep','bookkeeping preparation','bookkeeping document preparation','IRS Independent Contractor Defined'], ['outsourced-labor-backup-owner-plan','backup ownership','a backup owner plan','SBA hiring and managing employees'], ['philippines-crm-record-standards','CRM records','CRM record standards','NIST Cybersecurity Framework 2.0'], ['filipino-admin-document-review','document review','admin document review','NIST Cybersecurity Framework 2.0'], ['outsourced-labor-customer-update-guide','customer updates','customer update rules','SBA hiring and managing employees'], ['philippines-vendor-follow-up-ownership','vendor follow-up','vendor follow-up ownership','SBA hiring and managing employees'], ['filipino-virtual-assistant-calendar-planning','calendar planning','virtual assistant calendar planning','SBA hiring and managing employees'], ['outsourced-labor-work-queue-aging','queue age','work queue aging','SBA hiring and managing employees'], ['philippines-support-knowledge-handoff','support knowledge','a support knowledge handoff','SBA hiring and managing employees'], ['filipino-operations-daily-status','daily status','an operations daily status','SBA hiring and managing employees'], ['outsourced-labor-access-review','access review','an outsourced labor access review','CISA Require Multifactor Authentication'], ['philippines-admin-invoice-workflow','invoice preparation','invoice preparation','SBA hiring and managing employees'], ['filipino-customer-feedback-review','customer feedback','customer feedback review','SBA hiring and managing employees'], ['outsourced-labor-first-week-review','first-week review','a first-week role review','SBA hiring and managing employees'], ['philippines-remote-staff-continuity','staff continuity','remote staff continuity','NIST Cybersecurity Framework 2.0'],
] as const;
