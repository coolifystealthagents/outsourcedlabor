    ...
    <section className="hero-shell">
      ...
      <div className="hero-grid">
        <div className="hero-copy">
          <p className="eyebrow">Labor marketplace</p>
          <h1>Outsourced Labor: a labor roster for clearer staffing decisions.</h1>
          <p className="lead">A redesigned outsourced labor guide for owners comparing outsourced labor models for recurring business work. The page now uses a distinct direct response layout, industry-specific planning sections, and a conversion path that feels made for this niche.</p>
        ...
        <figure className="hero-media"><img src={site.heroImage || site.serviceImage} alt={site.alt || `${site.brand} planning visual`}/><figcaption>worker rosters and task tickets</figcaption></figure>
      </div>
    </section>
