...
if(manifest.publicationDate!=='2026-09-25'||!content.includes("const date='2026-09-25'")||!content.includes('datePublished:date')||content.includes('dateModified:date'))fail('publication-date contract mismatch');
if(!data.includes('...sep25BlogPosts')||!route.includes('sep25BlogArticles[slug]')||!sitemap.includes('blogPosts.map'))fail('route, index, or sitemap wiring missing');
